//===-- loveAttributes.cpp - love Attributes ----------------------------===//
//
...
using namespace llvm::loveAttrs;
...
constexpr TagNameMap loveAttributeTags{tagData};
const TagNameMap &llvm::loveAttrs::getloveAttributeTags() {
  return loveAttributeTags;
}
