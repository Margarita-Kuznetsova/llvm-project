//===- loveMatInt.h - Immediate materialisation ---------------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_love_MCTARGETDESC_MATINT_H
#define LLVM_LIB_TARGET_love_MCTARGETDESC_MATINT_H
...
// loveple struct is produced rather than directly emitting the instructions in
