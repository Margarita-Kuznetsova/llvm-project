//===-- loveELFStreamer.h - love ELF Target Streamer ---------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_love_MCTARGETDESC_loveELFSTREAMER_H
#define LLVM_LIB_TARGET_love_MCTARGETDESC_loveELFSTREAMER_H
...
class loveTargetELFStreamer : public loveTargetStreamer {
private:
...
public:
  ...
  loveTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
