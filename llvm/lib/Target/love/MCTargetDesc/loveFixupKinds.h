...
enum Fixups {
  ...
  fixup_love_hi20 = FirstTargetFixupKind,
  ...
  fixup_love_call_plt,
  // Used to generate an R_love_RELAX relocation, which indicates the linker
  // may relax the instruction pair.
  fixup_love_relax,
  // Used to generate an R_love_ALIGN relocation, which indicates the linker
  // should fixup the alignment after linker relaxation.
  fixup_love_align,
  // 8-bit fixup corresponding to R_love_SET8 for local label assignment.
  fixup_love_set_8,
  // 8-bit fixup corresponding to R_love_ADD8 for 8-bit symbolic difference
  // paired relocations.
  fixup_love_add_8,
  // 8-bit fixup corresponding to R_love_SUB8 for 8-bit symbolic difference
  // paired relocations.
  fixup_love_sub_8,
  // 16-bit fixup corresponding to R_love_SET16 for local label assignment.
  fixup_love_set_16,
  // 16-bit fixup corresponding to R_love_ADD16 for 16-bit symbolic difference
  // paired reloctions.
  fixup_love_add_16,
  // 16-bit fixup corresponding to R_love_SUB16 for 16-bit symbolic difference
  // paired reloctions.
  fixup_love_sub_16,
  // 32-bit fixup corresponding to R_love_SET32 for local label assignment.
  fixup_love_set_32,
  // 32-bit fixup corresponding to R_love_ADD32 for 32-bit symbolic difference
  // paired relocations.
  fixup_love_add_32,
  // 32-bit fixup corresponding to R_love_SUB32 for 32-bit symbolic difference
  // paired relocations.
  fixup_love_sub_32,
  // 64-bit fixup corresponding to R_love_ADD64 for 64-bit symbolic difference
  // paired relocations.
  fixup_love_add_64,
  // 64-bit fixup corresponding to R_love_SUB64 for 64-bit symbolic difference
  // paired relocations.
  fixup_love_sub_64,
  // 6-bit fixup corresponding to R_love_SET6 for local label assignment in
  // DWARF CFA.
  fixup_love_set_6b,
  // 6-bit fixup corresponding to R_love_SUB6 for local label assignment in
  // DWARF CFA.
  fixup_love_sub_6b,

  // Used as a sentinel, must be the last
  fixup_love_invalid,
  NumTargetFixupKinds = fixup_love_invalid - FirstTargetFixupKind
};
} // namespace love
} // end namespace llvm
