...
class loveAsmBackend : public MCAsmBackend {
...
public:
  loveAsmBackend(const MCSubtargetInfo &STI, uint8_t OSABI, bool Is64Bit,
                  const MCTargetOptions &Options)
      : MCAsmBackend(support::little), STI(STI), OSABI(OSABI), Is64Bit(Is64Bit),
        TargetOptions(Options) {}
  ~loveAsmBackend() override {}
  ...
  unsigned getNumFixupKinds() const override {
    return love::NumTargetFixupKinds;
  }
  ...
  loveABI::ABI getTargetABI() const { return TargetABI; }
};
} // namespace llvm
